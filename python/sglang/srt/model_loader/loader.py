...
class DefaultModelLoader(BaseModelLoader):
    ...
    def _load_weights_with_dram_offload_layered(
        ...
        # best contiguous huge pages. Non-skip weights are still on meta
        # device (zero DRAM usage).
        ...
        # format_cast(NZ) operations from Phase 2's
        # process_weights_after_loading are complete.
