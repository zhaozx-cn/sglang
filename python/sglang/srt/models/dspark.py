...
def run_markov_block(
    ...
    *,
    ...
    if proposal_len == 0:
        ...
        return empty, base_logits if collect_corrected else None
...
class Nemotron35VanillaMarkov(VanillaMarkov):
    ...
    def __init__(
        ...
        *,
        ...
        # This subclass deliberately bypasses VanillaMarkov.__init__ because
        # markov_w2 is quantized. Keep the base class' TP-shard state explicit
        # so its shared proposal methods remain safe after the A5 port.
        self._tp_shard: Optional[_DenseMarkovW2ShardGeometry] = None
        self._shard_group = None
